        ...
        <>
          <div className="contact">
            ...
            <form  className="form">
              ...
              <input onChange={e=>setName(e.target.value.toUpperCase())} placeholder="Enter Your Name!" type="text" required/>
              <label htmlFor="email">Emial :</label>
              <input  type="email" placeholder="Enter your Email!" onChange={e=>setEmail(e.target.value.toLowerCase())} name="email" id="email" required/>
              <label htmlFor="message">Message :</label>
              <textarea required placeholder="Please type your message here Notice you can not just Submit an empty or less than 10 character Message!" onChange={e=>setMsg(e.target.value)} name="message" id="message" cols="30" rows="10"></textarea>
